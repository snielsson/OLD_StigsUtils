...
public static class LogServiceExtensions
{
  ...
  public static ILoggerFactory LoggerFactory {
    get
    {
      if (_loggerFactory == null) throw new InvalidOperationException("LoggerServiceExtensions.LoggerFactory has not been set.");
      return _loggerFactory;
    }
  }
  
  public static IServiceCollection AddLogService(this IServiceCollection @this, Action<IServiceProvider, LogService> configure)
  {
    return @this;
  }
  
  /// <summary>
  /// Convenience extenions to avoid having to inject ILogger<T> in all classes.
  /// </summary>
  //public ILogger<T> Log<T>(this T @this) 
